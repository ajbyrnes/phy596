...
# 
# ==============================================================
set ::env(PATH) "$::env(PATH);E:/Vitis_HLS/2023.1/win64/tools/fpo_v7_1"
set ::env(PATH) "$::env(PATH);E:/Vitis_HLS/2023.1/win64/tools/fft_v9_1"
set ::env(PATH) "$::env(PATH);E:/Vitis_HLS/2023.1/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);E:/Vitis_HLS/2023.1/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fit.autotvin.dat"
	set constFileTvOut       "fit.autotvout.dat"
	set constFileHdlTvIn     "fit.autohdltvin.dat"
	set constFileHdlTvOut    "fit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
