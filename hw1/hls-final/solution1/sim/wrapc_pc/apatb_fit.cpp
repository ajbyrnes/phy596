...
// wrapc file define:
#define AUTOTB_TVIN_input_r "../tv/cdatafile/c.fit.autotvin_input_r.dat"
...
#define AUTOTB_TVOUT_output_r "../tv/cdatafile/c.fit.autotvout_output_r.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.fit.autotvout_output_r.dat"
...
extern "C"
void fit_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_fit_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
  ...
  port0.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_input_r;
  port0.hasWrite = false;

  static hls::sim::Stream<hls::sim::Byte<48>> port1 {
    .width = 384,
    .name = "output_r",
#ifdef POST_CHECK
  ...
  port1.param = (hls::stream<hls::sim::Byte<48>>*)__xlx_apatb_param_output_r;
  port1.hasWrite = true;
  ...
  try {
    ...
    fit_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
    port1.buffer();
