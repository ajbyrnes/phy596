...
extern "C" void fit(__cosim_s8__*, __cosim_s48__*);
extern "C" void apatb_fit_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
using hls::sim::createStream;
auto* sinput_r = createStream((hls::stream<__cosim_s8__>*)__xlx_apatb_param_input_r);
  //Create input buffer for output_r
  ap_apatb_output_r_cap_bc = __xlx_output_r_V_size_Reader.read_size();
  __cosim_s48__* __xlx_output_r_input_buffer= new __cosim_s48__[ap_apatb_output_r_cap_bc];
auto* soutput_r = createStream((hls::stream<__cosim_s48__>*)__xlx_apatb_param_output_r);
  // DUT call
  fit(sinput_r->data<__cosim_s8__>(), soutput_r->data<__cosim_s48__>());
sinput_r->transfer((hls::stream<__cosim_s8__>*)__xlx_apatb_param_input_r);
soutput_r->transfer((hls::stream<__cosim_s48__>*)__xlx_apatb_param_output_r);
}
