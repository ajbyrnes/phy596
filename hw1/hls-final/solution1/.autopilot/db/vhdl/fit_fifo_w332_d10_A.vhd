...
entity fit_fifo_w332_d10_A is
    generic (
        MEM_STYLE         : string  := "auto";
        DATA_WIDTH        : integer := 332;
...
architecture arch of fit_fifo_w332_d10_A is

    -- component
    component fit_fifo_w332_d10_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
        DATA_WIDTH : natural := 332;
...
begin
----------------------- Instantiation -----------------------
    U_fit_fifo_w332_d10_A_ram : fit_fifo_w332_d10_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity fit_fifo_w332_d10_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 332;
        ADDR_WIDTH  : integer := 4;
...
architecture arch of fit_fifo_w332_d10_A_ram is
